  ...
  return (
    <div className="mt-8">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mt-4">
        <div className="">
          <img
            className="md:h-80 h-32 w-96 rounded-lg border-4 hover:grayscale cursor-pointer "
        ...
        <div>
          <img
            className="md:h-80 h-32 w-96 rounded-lg hover:grayscale cursor-pointer border-4"
